...
public class ItemService : Singleton<ItemService>, IDisposable {
	...
	public ItemService()
	{
		MessageDistributer.Instance.Subscribe<ItemBuyRespones>(this.OnItemBuy);
		MessageDistributer.Instance.Subscribe<ItemEquipResponse>(this.OnItemEquip);
	}

	public void Dispose()
	{
		MessageDistributer.Instance.Unsubscribe<ItemBuyRespones>(this.OnItemBuy);
	...
	private void OnItemBuy(object sender,ItemBuyRespones message)
	{
